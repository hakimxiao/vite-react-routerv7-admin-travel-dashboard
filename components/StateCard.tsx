...
const StateCard = ({headerTitle, total, lastMonthCount, currentMonthCount}: StatsCard) => {
    ...
    return (
        <article className="stats-card">
            ...
            <div className="content">
                ...
                <img src={`/assets/icons/${isDecrement ? "decrement.svg" : "increment.svg"}`} alt="trend graf" className="xl:w-32 w-full h-full md:h-32 xl:h-full"/>
            </div>
        </article>
    )
}
