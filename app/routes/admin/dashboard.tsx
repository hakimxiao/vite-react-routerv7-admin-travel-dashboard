        ...
        <section className="grid grid-cols-1 lg:grid-cols-2 gap-5">
            ...
            >
                ...
                <SeriesCollectionDirective>
                    ...
                    <SeriesDirective // ini adalah diagram nya
                        dataSource={userGrowth}
                        xName="day" // x name : diisi dengan userGrowth.day
                        yName="count" // y name : diisi dengan userGrowth.count
                        type="Column" // tipe : diagram histogram
                        name="Column"
                        columnWidth={0.3}
                    ...
                    <SeriesDirective
                        ...
                        xName="day" // x name : diisi dengan userGrowth.day
                        yName="count" // y name : diisi dengan userGrowth.count
                        type="SplineArea" // tipe : diagram waves
                        name="Wave"
            ...
            >
                ...
                <SeriesCollectionDirective>
                    ...
                    <SeriesDirective
                        ...
                        xName="travelStyle"  // dari : tripsByTravelStyle.travelStyle
                        yName="count" // dari : tripsByTravelStyle.count
                        type="Column"
                        name="day"
                        columnWidth={0.3}
                        cornerRadius={{topLeft: 10, topRight: 10}}
